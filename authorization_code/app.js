...
app.get('/login', function(req, res) {
  ...
  var scope = 'user-read-private user-read-email user-read-private playlist-read-private user-library-modify playlist-modify-public playlist-modify-private';
